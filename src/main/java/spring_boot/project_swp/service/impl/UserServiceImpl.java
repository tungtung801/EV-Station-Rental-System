...
public class UserServiceImpl implements UserService {
    ...
    public void uploadDocumentImage(Long userId, String documentType, MultipartFile file) {
        ...
        // In a real application, you would save the file to a storage service (e.g., AWS S3, local
        // disk)
    ...
    public User FindUserByUserId(@NotBlank(message = "UserId is required") Long userId) {
