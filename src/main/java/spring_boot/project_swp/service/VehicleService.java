...
public interface VehicleService {
    ...
    List<VehicleResponse> findVehiclesByLocation(Long locationId);

    List<VehicleResponse> findVehiclesByModel(String modelName);

    List<VehicleResponse> findVehiclesByName(String query);
}