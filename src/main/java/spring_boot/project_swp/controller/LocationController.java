...
public class LocationController {
    ...
    @GetMapping("/findAndParseLocation/{address}")
    @Operation(
            summary = "Find and parse location from address",
            description = "Finds and parses location details from a given address string.")
    public ResponseEntity<Location> findAndParseLocation(@PathVariable String address) {
        return new ResponseEntity<>(locationService.findAndParseLocationFromAddress(address), HttpStatus.OK);
    }
}
